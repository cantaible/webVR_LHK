...
vreticle.Reticle = function(camera) {
    ...
    new_reticle.get_random_hex_material_1 = function() {
        // 当注视
    ...
    new_reticle.create_reticle = function(camera) {
        ...
        this.reticle_object = this.create_default_object(new THREE.Vector3(0, 0, -.5), true, .005, undefined, true);
    ...
    new_reticle.detect_reticle_hit = function() {
        ...
        var vector = new THREE.Vector3(-0.0012499999999999734, -0., 0.5);
        ...
        if (intersects.length > 0) {
            ...
            if (this.gazing_object != null) {
                ...
                this.reticle_object.material.material = 0x123456;
            }
        }
    }
